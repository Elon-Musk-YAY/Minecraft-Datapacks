...
execute at @s as @e[tag=tv_stand] if score @s equal_rot matches 0 if score @s tv_rotate matches 0 run tellraw @p {"text": "Your TV will now rotate!", "color": "green"}
execute at @s as @e[tag=tv_stand] if score @s equal_rot matches 0 run scoreboard players set @s tv_rotate 1