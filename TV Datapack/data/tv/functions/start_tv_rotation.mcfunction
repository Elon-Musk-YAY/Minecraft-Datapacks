...
execute at @s as @e[tag=tv_stand] if score @s equal_rot matches 0 if score @s channel_rot matches 0 run tellraw @p {"text": "Your TV will now automatically change channels!", "color": "green"}
execute at @s as @e[tag=tv_stand] if score @s equal_rot matches 0 run scoreboard players set @s channel_rot 1
